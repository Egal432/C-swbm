...
from visualize_results import plot_timeseries, plot_scatter_comparison, plot_monthly_comparison, print_statistics


def run_complete_analysis(filepaths, output_dir='complete_outputs', 
                         exp_runoff=2.0, exp_et=0.5, beta=0.8, whc=150.0,
                         melting=None, use_snow=False,
                         create_plots=True):
    """
    ...
    print(f"  beta:       {beta}")
    print(f"  WHC:        {whc} mm")
    print(f"  melting:    {melting}")
    print(f"  use_snow:   {use_snow}")
